...
Pero no siempre sale el 100\% depende de las muestras que escoja de ejemplo de validación pero habiendo comprobado bastantes veces el fallo es muy bajo, el acierto suele ser superior al 90\% por lo que se puede considerar un porcentaje de acierto optimo.
 \end{itemize} 

Con los datos obtenidos en la gráfica de evolución de aprendizaje y en la matriz de confusión se puede decir que para un conjunto de datos numéricos el algoritmo de redes neuronales es optimo para su reconocimiento y que las muestras se están recogiendo de la forma correcta y la extracción de características es correcta porque los algoritmos ya estaban creados y funcionaban correctamente pero para ello había que pasarles las características extraidas de las muestras de la forma correcta.
...
\begin{figure}
	\centering
	\includegraphics[width=9cm, keepaspectratio]{img/le_num_rn.png}
	\caption{Gráfica de evolución de aprendizaje redes neuronales con datos numéricos} 	\label{fig:ejemplo5}
\end{figure}

\begin{figure}
	\centering
	\includegraphics[width=9cm, keepaspectratio]{img/cm_num_rn.png}
	\caption{Matriz de confusión redes neuronales con datos numéricos} 	\label{fig:ejemplo6}
\end{figure}
...
\begin{itemize}
\item[•] Se escoge una muestra de la clase iris setosa, se introduce en la parte de testeo y como resultado se ve que clase se le asigna. En la figura~\ref{fig:ejemplo7} se puede observar el porcentaje de que la muestra evaluada pertenezca a una clase u otra, en este caso ha acertado ya que indica que al 99.5\% pertenece a la clase iris setosa. Se realizan además varias comprobaciones más con muestras de esta clase y las clasifica correctamente.
\item[•] Se escoge una muestra de la clase iris virginica, en este caso ha acertado ya que indica que al 96.55\% pertenece a la clase iris virgínica como se puede observar en la figura~\ref{fig:ejemplo8}. Se realizan además varias comprobaciones más con muestras de esta clase y las clasifica correctamente.
\item[•] Se escoge una muestra de la clase iris versicolor, en este caso ha acertado ya que indica que al 96.71\% pertenece a la clase iris versicolor como se puede observar en la figura~\ref{fig:ejemplo9}. Se realizan además varias comprobaciones más con muestras de esta clase y las clasifica correctamente.
\end{itemize}

\begin{figure}
	\centering
	\includegraphics[width=9cm, keepaspectratio]{img/iris_set_num_rn.png}
	\caption{Muestra de test de la clase iris setosa} 	\label{fig:ejemplo7}
\end{figure}

\begin{figure}
	\centering
	\includegraphics[width=9cm, keepaspectratio]{img/iris_vir_num_rn.png}
	\caption{Gráfica de evolución de aprendizaje redes neuronales con datos numéricos} 	\label{fig:ejemplo8}
\end{figure}

\begin{figure}
	\centering
	\includegraphics[width=9cm, keepaspectratio]{img/iris_ver_num_rn.png}
	\caption{Matriz de confusión redes neuronales con datos numéricos} 	\label{fig:ejemplo9}
\end{figure}
...
Para la validación de un modelo se puede abrir el inspector del navegador y al crear el modelo en la consola se 
